...
fn resolve_symbol_pin_text_var(
    ...
    if let Some(lib_pin) = resolved_symbol_pin_in_unit(symbol, current_unit, pin_number) {
        ...
        return match token_kind {
            SymbolPinTextVarKind::NetName => graph_net
                .as_ref()
    ...
    for alternate_path in ordered_sheet_paths(sheet_paths, loaded_path) {
        ...
        for item in &schematic.screen.items {
                ...
                resolved_symbol_pin_in_unit(candidate_symbol, pin_unit, pin_number)
            {
                ...
                return match token_kind {
                    SymbolPinTextVarKind::NetName => reduced_graph
                        .and_then(|graph| {
                            resolve_reduced_project_net_for_symbol_pin(
                                graph,
                                alternate_path,
                    ...
                    SymbolPinTextVarKind::ShortNetName => reduced_graph
                        ...
                        .or_else(|| Some(String::new())),
                    SymbolPinTextVarKind::NetClass => reduced_graph
                        .and_then(|graph| {
                            resolve_reduced_project_net_for_symbol_pin(
                                graph,
                                alternate_path,
...
pub(crate) fn resolve_cross_reference_text_var(
    ...
    resolve_cross_reference_text_var_with_graph(
        schematics,
        sheet_paths,
        loaded_path,
        project,
...
fn resolve_cross_reference_text_var_with_graph(
    schematics: &[Schematic],
    sheet_paths: &[LoadedSheetPath],
    loaded_path: &LoadedSheetPath,
    project: Option<&LoadedProjectSettings>,
